...
public class Tbl_storeFormView extends View {
	...
	public Tbl_storeFormView(){
		...
		btn_list = new IGRPButton("List","gestao_compras","Tbl_storeForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("rel","list").add("action-id","83").add("crud_op","list").add("type","specific");

		btn_save = new IGRPButton("Save","gestao_compras","Tbl_storeForm","save","submit","primary|fa-save","","");
		btn_save.propertie.add("rel","save").add("action-id","82").add("crud_op","save").add("type","specific");
