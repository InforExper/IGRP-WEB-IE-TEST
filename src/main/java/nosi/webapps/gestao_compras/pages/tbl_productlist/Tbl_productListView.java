...
public class Tbl_productListView extends View {
	...
	public Tbl_productListView(){
		...
		btn_new = new IGRPButton("New","gestao_compras","Tbl_productList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("rel","new").add("action-id","85").add("crud_op","addNew").add("type","specific");

		btn_update = new IGRPButton("Update","gestao_compras","Tbl_productList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("rel","update").add("action-id","85").add("crud_op","edit").add("type","form");

		btn_delete = new IGRPButton("Delete","gestao_compras","Tbl_productList","delete","confirm","danger|fa-trash","","");
		btn_delete.propertie.add("rel","delete").add("action-id","86").add("crud_op","delete").add("type","form");
