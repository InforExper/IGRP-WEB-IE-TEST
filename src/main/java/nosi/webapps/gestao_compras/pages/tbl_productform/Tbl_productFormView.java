...
/*Create View*/
package nosi.webapps.gestao_compras.pages.tbl_productform;
...
public class Tbl_productFormView extends View {
	...
	public Tbl_productFormView(){
		...
		btn_list = new IGRPButton("List","gestao_compras","Tbl_productForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("rel","list").add("action-id","86").add("crud_op","list").add("type","specific");

		btn_save = new IGRPButton("Save","gestao_compras","Tbl_productForm","save","submit","primary|fa-save","","");
		btn_save.propertie.add("rel","save").add("action-id","85").add("crud_op","save").add("type","specific");
