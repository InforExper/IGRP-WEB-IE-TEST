package nosi.webapps.gestao_veiculo.process.process_cat;
...
import nosi.webapps.gestao_veiculo.pages.solicitar_page.Solicitar_page;
import nosi.webapps.gestao_veiculo.pages.solicitar_page.Solicitar_pageView;
...
public class TaskaprovaController extends BPMNTaskController {

	public Response actionIndex() throws IOException, ServletException, IllegalArgumentException, IllegalAccessException {
		Solicitar_pageView view = new Solicitar_pageView();
		Solicitar_page model = new Solicitar_page();
		model.load();
